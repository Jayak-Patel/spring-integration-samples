...
public final class EmailParserUtils {
	...
	public static class AttachmentTransformationException extends RuntimeException {

		public AttachmentTransformationException(String message, Throwable cause) {
			super(message, cause);
		}
	...
	public static Collection<AbstractIntegrationMessageBuilder<?>> transformEmailMessageToAttachmentMessage(
		...
		try {
			...
			throw new AttachmentTransformationException("Could not transform message", e);
		}
		return messages;
	}
